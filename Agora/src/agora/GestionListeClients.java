            ...
            if (ic.getCouleur()!=null){
                if(ic.getCouleur().equals(Couleur)){
                    ic.getWriter().println(Couleur);
                     ...
                     System.out.println("The Mutation is Completed new Color is "+ Couleur);
                      ic.setCouleur(null);
                waintingcount--;
                }
                  ...
                  ic.getWriter().println("Yellow");
                     icc.getWriter().println("Yellow");
                        System.out.println("The Mutation is Completed new Color is "+"Yellow");
                         ic.setCouleur(null);
                 waintingcount--;
            }
                  ...
                  ic.getWriter().println("Red");
                     ...
                     System.out.println("The Mutation is Completed new Color is "+"Red");
                      ic.setCouleur(null);
                 waintingcount--;
            }
                  ...
                  ic.getWriter().println("Blue");
                     ...
                     System.out.println("The Mutation is Completed new Color is "+"Blue");
                      ic.setCouleur(null);
                waintingcount--;
            }
